        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-8">
                ...
                <div class="media py-1">
                    ...
                    <img src="{{ optional($data['post']->userMeta)->avatar ? $data['post']->userMeta->avatar :sprintf('%s%s%s', 'https://secure.gravatar.com/avatar/', md5(strtolower(trim($data['author']->email))), '?s=200') }}"
