<header class="blog-header py-3 border-bottom">
    <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
            <p class="my-auto">
                <a href="https://twitter.com/jayceedaily" class="pr-3 text-decoration-none" target="_blank" rel="noopener">
                ...
                <a href="https://github.com/jayceedaily" class="text-decoration-none" target="_blank" rel="noopener">
        ...
        <div class="col-4 text-center">
            <a id="brand" class="text-dark font-weight-bold text-decoration-none font-serif" href="{{ route('blog.index') }}">{{ config('app.name', __('canvas::blog.title')) }}</a>
        </div>
